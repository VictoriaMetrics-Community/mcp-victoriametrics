...
* FEATURE: [metrics](https://docs.victoriametrics.com/victorialogs/metrics/): expose minimum and maximum timestamps across stored logs via `vl_storage_log_min_timestamp_seconds` and `vl_storage_log_max_timestamp_seconds`. See [#695](https://github.com/VictoriaMetrics/VictoriaLogs/issues/695).
